# 【実際どう？】Agent Builderの使い方やn8nとの比較を解説【正直レビュー】

| 項目 | 内容 |
|------|------|
| **動画URL** | https://www.youtube.com/watch?v=HOjzVQx_WBE |
| **チャンネル** | AIでサボろうチャンネル |
| **公開日** | 2025年10月08日 |
| **再生時間** | 11:06 |
| **再生回数** | 9,874 |
...
## 概要
OpenAIのDevDayで発表された新機能Agent Builder。
その使い方を交えながら、実際のところn8nやDifyなど既存のワークフローツールを置き換えるようなものであるのかを正直レビューしていきます。

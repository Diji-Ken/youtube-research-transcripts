# OpenAIのAgentKit（Agent Builder & Chatkit）でのアプリ作成を実演解説

| 項目 | 内容 |
|------|------|
| **動画URL** | https://www.youtube.com/watch?v=uMVRPqC7cL4 |
...
## 概要
OpenAIからリリースされたAIエージェント作成ツール『AgentKit（Agent Builder & Chatkit）』を実演解説します。
